...
class SCColorTheme {
  ...
  Color get primaryColorBlue600 => const Color(0xff0F2630);
  Color get primaryColorBlue500 => const Color(0xFF088395);
  Color get primaryColorBlue400 => const Color(0xFF8FB9FF);
  ...
  Color get primaryColorBlue800 => const Color(0xFF021d28);
  ...
  //checkbox color
  Color customCheckboxColor = Color(0xFF77D9A5);
  Color tickcolor= Color(0xFF076445);
